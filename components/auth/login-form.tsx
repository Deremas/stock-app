  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <Input
          className="h-10 rounded-xl border-slate-300 bg-white text-slate-900 shadow-sm placeholder:text-slate-500 focus-visible:ring-primary/85 focus-visible:ring-offset-0 sm:h-11"
          id="identifier"
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            className="h-10 rounded-xl border-slate-300 bg-white pr-12 text-slate-900 shadow-sm placeholder:text-slate-500 focus-visible:ring-primary/85 focus-visible:ring-offset-0 sm:h-11"
            id="password"
      ...
      <Button className="h-10 w-full rounded-xl shadow-sm sm:h-11" type="submit" disabled={isPending}>
