...
export function AppShell({
  ...
  return (
    <div className="h-screen w-full max-w-full bg-background">
      <AppSidebar
        role={user.role}
      ...
      >
        ...
        />
        <main className="flex-1 min-w-0 max-w-full px-4 pb-5 pt-5 sm:px-6 sm:pb-6 sm:pt-6 lg:px-8 lg:pb-8 lg:pt-6">
