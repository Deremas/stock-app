...
import { getAlertRecordRows, getLowStockRows, getOutOfStockRows, getProductRows, getStockMovementRows, getStockOverviewRows, getTransferRows, } from "@/lib/page-data-inventory";
import { getCustomerCreditRows, getCustomerPaymentRows, getCustomerRows, getSalesProfitRows, getSalesRows, getSoldItemRows, } from "@/lib/page-data-sales";
import { getBranchRows, getCashAccountRows, getExpenseCategorySummaryRows, getExpenseRows, getExpenseKpis, getFinanceAccountRows, getLedgerRows, getPurchaseRows, getRoleRows, getSupplierPaymentRows, getSupplierRows, getUserRows, getAuditLogRows, getCashTransferRows, } from "@/lib/page-data-purchases-finance-admin";
import { getSellerAssignedRows, getSellerAssignCandidateRows, getSellerCollectionRows, getSellerIntakeRows, getSellerReturnRows, getSellerRows, getSellerSettlementRows, } from "@/lib/page-data-sellers";
function emptyReportConfig(title, description) {
    return {
        eyebrow: "Reports",
        title,
        description,
...
export async function getTablePageConfig(key, filters = {}) {
    ...
    switch (key) {
        ...
        case "inventoryStockOverview":
            return {
                eyebrow: "Inventory",
                title: "Current Stock",
                description: "Live stock balances by branch with remaining owned batch quantities and prices shown inline for faster stock review.",
        ...
        case "inventoryLowStock":
            return {
                eyebrow: "Inventory",
                title: "Low Stock",
                description: "Items that have reached or fallen below the configured minimum stock level.",
        ...
        case "inventoryOutOfStock":
            return {
                eyebrow: "Inventory",
                title: "Out Of Stock",
                description: "Finished items by branch that are currently unavailable and ready for replenishment.",
        ...
        case "inventoryStockMovements":
            return {
                ...
                description: "Ledger-style item movement history with source traceability across stock flows.",
        ...
        case "inventoryTransfers":
            return {
                eyebrow: "Inventory",
                title: "Transfers",
                description: "Posted stock movements between branches with source and destination balances kept in sync.",
        ...
        case "salesSoldItems":
            return {
                eyebrow: "Sales",
                title: "Sold Items",
                description: "Line-level sold item history showing source ownership, seller linkage, and pricing.",
        ...
        case "salesList":
            return {
                eyebrow: "Sales",
                title: "Sales List",
                description: "Branch sales ledger with payment mode, outstanding balance, and posting timestamps.",
        ...
        case "salesCustomers":
            return {
                eyebrow: "Sales",
                title: "Customers",
                description: "Registered customer directory with purchase totals and outstanding credit.",
        ...
        case "purchasesList":
            return {
                eyebrow: "Purchases",
                title: "Purchase List",
                description: "Purchase history with branch context, optional supplier linkage, totals, and payable status.",
        ...
        case "purchasesSuppliers":
            return {
                eyebrow: "Purchases",
                title: "Suppliers",
                description: "Supplier master data with payable balances and purchase counts.",
        ...
        case "purchasesSupplierPayments":
            return {
                ...
                description: "Supplier payment history posted against purchase liabilities.",
                actionLabel: "Record payment",
        ...
        case "sellersList":
            return {
                eyebrow: "Partners",
                title: "Partners",
                description: "Partner list showing received-stock payables separately from assigned-stock receivables.",
        ...
        case "sellersIntakeRecords":
            return {
                ...
                description: "Items received from partners with sold, returned, and remaining quantities.",
        ...
        case "sellersAssignItems":
            return {
                eyebrow: "Partners",
                title: "Assign Items",
                description: "Available owned batches that can be issued to partners. Sold quantity is settled later, while unsold quantity can be returned into branch stock.",
        ...
        case "sellersAssignedItems":
            return {
                ...
                description: "Assignment history showing issued quantities, sold quantities, returned-to-stock quantities, and what is still out with the partner.",
        ...
        case "sellersReturns":
            return {
                eyebrow: "Partners",
                title: "Returns",
                description: "Posted returns of unsold received items back to the partner, and unsold assigned items back into branch stock.",
        ...
        case "sellersSettlements":
            return {
                eyebrow: "Partners",
                title: "Pay Partners",
                description: "Pay exact sold received-partner lines with payment-account traceability. Assigned-from-us items are collected separately.",
        ...
        case "sellersCollections":
            return {
                ...
                description: "Receive cash or bank collection for sold items previously assigned from branch stock.",
        ...
        case "financeAccounts":
            return {
                eyebrow: "Finance",
                title: "Accounts",
                description: "Branch bank and cash accounts with ledger-derived balances and posting controls.",
        ...
        case "financeCash":
            return {
                eyebrow: "Finance",
                title: "Cash",
                description: "Cash account balances by branch with quick bank deposit actions.",
        ...
        case "financeExpenses":
            return {
                eyebrow: "Finance",
                title: "Expenses",
                description: "Expense records tied to payment accounts, categories, and branches.",
        ...
        case "financeLedger":
            return {
                eyebrow: "Finance",
                title: "Ledger",
                description: "Combined account transaction feed for sales, purchases, and finance flows.",
        ...
        case "reportsInventory":
            return emptyReportConfig("Inventory Reports", "Report execution surfaces will populate here from real data filters.");
        case "reportsSales":
            return {
                eyebrow: "Reports",
                title: "Sales Profit",
                description: "Daily sale lines with revenue, cost or partner payable, and gross profit.",
        ...
        case "reportsPurchases":
            return emptyReportConfig("Purchase Reports", "Report execution surfaces will populate here from real data filters.");
        case "reportsSellers":
            return {
                eyebrow: "Reports",
                title: "Partner Exposure",
                description: "Open received-stock quantities, assigned-out quantities, unpaid partner payables, and uncollected partner receivables grouped per partner, with row actions to drill into each partner history.",
        ...
        case "reportsFinance":
            return {
                ...
                description: "Expense totals by category and branch for the selected reporting window.",
        ...
        case "adminUsers":
            return {
                ...
                title: "Users",
                description: "User accounts with branch assignment, role, and active state visibility.",
        ...
        case "adminAuditLogs":
            return {
                eyebrow: "Administration",
                title: "Audit Logs",
                description: "High-level audit events for stock, finance, and admin activity.",
        ...
        case "adminSettings":
            return {
                eyebrow: "Administration",
                title: "Settings",
                description: "Settings will appear here once persisted system configuration is implemented.",
