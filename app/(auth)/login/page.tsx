          ...
          <CardContent className="flex h-full flex-col justify-between gap-10 p-10">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="rounded-2xl border border-white/25 bg-white/14 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.14)]">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/78">Simple daily operations</p>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <p className="max-w-lg text-base leading-7 text-white/88">
                  Sign in and continue with your day-to-day work.
                </p>
              </div>
            </div>
            <div className="rounded-3xl border border-white/18 bg-white/12 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
              <p className="text-lg font-medium text-white">Fast stock flow</p>
            ...
            <div className="mx-auto max-w-md space-y-5 sm:space-y-6">
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3 lg:hidden">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-900">Stock App</p>
                    <p className="text-xs text-slate-600">Simple daily operations</p>
                  </div>
                </div>
