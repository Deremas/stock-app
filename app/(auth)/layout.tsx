...
export default async function AuthLayout({
  ...
  return (
    <main className="relative flex h-dvh items-center justify-center overflow-hidden bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(244,248,252,1))] px-3 py-3 sm:px-4 sm:py-4">
